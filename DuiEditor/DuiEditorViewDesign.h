...
public:
	...
	afx_msg void OnEditGenerateCode_DeclareCommand();
	afx_msg void OnUpdateEditGenerateCode_DeclareCommand(CCmdUI *pCmdUI);
...
// 	afx_msg void OnUpdateSetDPI(CCmdUI *pCmdUI);
	afx_msg void OnSetDPI_100();
	afx_msg void OnSetDPI_125();
	afx_msg void OnSetDPI_150();
	afx_msg void OnSetDPI_175();
	afx_msg void OnSetDPI_200();
	afx_msg void OnSetDPI_225();
	afx_msg void OnSetDPI_250();
	afx_msg void OnSetDPI_300();
	afx_msg void OnSetDPI_Custom();
	afx_msg void OnUpdateSetDPI_100(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_125(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_150(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_175(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_200(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_225(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_250(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_300(CCmdUI *pCmdUI);
	afx_msg void OnUpdateSetDPI_Custom(CCmdUI *pCmdUI);
